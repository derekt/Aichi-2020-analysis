...
options(warn = -1)
  ...
  output_name = "T11_PA_coverage_birds_mammals_amphibians" 

#--------------------------------------------------------------------------------------

# Read in and attach data
eafs<-read.csv("pa_coverage_spp_dist_mean.csv")
...
target_value = -99999999999999
y_limit = 60
target_value_text = -999999999999999
ylabel = "Percent meeting target"
maintitle = "PA coverage of bird, mammal and amphibian species"
...
m[[1]] <- FitAutocorrelatedModel("poly1fun", "(a,b,Year)", 2, "eafs", "list(a =1, b = 1)", "coef(m1)", "coef(m1)", TRUE, num_data_points = num_data_points, ylabel, "First order polynomial")
...
#--------------------------------------------------------------------------------------
# MODEL 4: HYPERBOLIC
m[[4]] <- FitAutocorrelatedModel("hyperfun", "(a,b,Year)", 2, "eafs", "list(a = 10, b = 0.5)", "coef(m1)", "list(a = -87, b = -105)", TRUE, num_data_points = num_data_points, ylabel, "Hyperbolic")
...
m[[6]] <- FitAutocorrelatedModel("hiiifun", "(a,b,Year)", 2, "eafs", "list(a = 1.1, b = 1)", "coef(m1)", "list(a = 1.1, b = 20)", TRUE, num_data_points = num_data_points, ylabel, "Hollings Type III")
