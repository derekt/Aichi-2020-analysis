...
setwd("../../data/Target 7")
    ...
    output_name = "T7_Area_conservation_agriculture"



# Read in and attach data
eafs<-read.csv("Area_conservation_agriculture.csv")
...
y_limit = max(eafs[,2]) * minx * 1.6
target_value_text = -999999999999
ylabel = "Million ha"
maintitle = "Area under conservation agriculture"
...
#< 10 data points so only fit 2 parameter models
...
m[[1]] <- FitAutocorrelatedModel("poly1fun", "(a,b,Year)", 2, "eafs", "list(a =-22, b = 50)", "coef(m1)", "coef(m1)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "First order polynomial")
  ...
  m[[2]] <- FitAutocorrelatedModel("ratk423", "(a,b,Year)", 3, "eafs", "list(a = 100, b = 1)", "coef(m1)", "coef(m1)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "2 parameter negative exponential")
  
  #-------------------------------------------------------------------------------------
  # MODEL 3: 4.3.33 FROM RATKOWSKY
  m[[3]] <- FitAutocorrelatedModel("ratk4333", "(a,b,c,Year)", 4, "eafs", "list(a = 100, b = -1, c = 0.5)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "3 parameter negative exponential", nofit = TRUE)
...
m[[5]] <- FitAutocorrelatedModel("mmfun", "(a,b,Year)", 2, "eafs", "list(a = 10, b = 1)", "coef(m1)", "list(a = 1.3, b = 1.3)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Michaelis-Menten")
...
m[[7]] <- FitAutocorrelatedModel("hivfun", "(a,b,c,Year)", 3, "eafs", "list(a = 1.1, b = 1, c = 1)", "coef(m1)", "list(a = 1.1, b = 0.03, c = 1)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Hollings Type IV", nofit = TRUE)

#--------------------------------------------------------------------------------------
# MODEL 8: RATIONAL
m[[8]] <- FitAutocorrelatedModel("rationalfun", "(a,b,d,Year)", 3, "eafs", "list(a = 1.1, b = 1, d = 1)", "coef(m1)", "list(a = 1.1, b = 0.03, d = 1)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Rational", nofit = TRUE)
...
m[[10]] <- FitAutocorrelatedModel("monofun", "(a,b,Year)", 2, "eafs", "list(a = 130, b = -0.1)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Monomolecular")
...
#--------------------------------------------------------------------------------------
# MODEL 12: GOMPERETZ
m[[12]] <- FitAutocorrelatedModel("gompertzfun", "(a,b,d,Year)", 3, "eafs", "list(a = 1.1, b =0.1,d = 0.1)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Gompertz", nofit = TRUE)

#--------------------------------------------------------------------------------------
# MODEL 13: CHAPMAN-RICHARDS
m[[13]] <- FitAutocorrelatedModel("chaprichfun", "(a,b,d,Year)", 3, "eafs", "list(a = 12, b = 0.2,d = 0.02)", "list(a = 1.1, b = 0.1,d = 5)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Chapman-Richards", nofit = TRUE)

#---------------------------------------------------------------------------------------
# MODEL 14: WEBIFULL
m[[14]] <- FitAutocorrelatedModel("weibullfun", "(a,b,d,e,Year)", 4, "eafs", "list(a = 2, b = 2,d = 2, e= 0.01)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Weibull", nofit = TRUE)

#---------------------------------------------------------------------------------------
# MODEL 15: POWER-LAW
m[[15]] <- FitAutocorrelatedModel("powerfun", "(a,b,Year)", 2, "eafs", "list(a = 200, b = -0.8)", "coef(m1)", "coef(m2)8)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Power", nofit = TRUE)

#--------------------------------------------------------------------------------------
# MODEL 16: ASYMPTOTIC
m[[16]] <- FitAutocorrelatedModel("asymptoticfun", "(a,b,d,Year)", 3, "eafs", "list(a = 1000, b = 2, d = 1)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Asymptotic", nofit = TRUE)

#--------------------------------------------------------------------------------------
# MODEL 17: SHEPHERD
m[[17]] <- FitAutocorrelatedModel("shepherdfun", "(a,b,d,Year)", 3, "eafs", "list(a = 2, b = 2, d = 0.98)", "coef(m1)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Shepherd", nofit = TRUE)

#--------------------------------------------------------------------------------------
# MODEL 18: HASSELL
m[[18]] <- FitAutocorrelatedModel("hassellfun", "(a,b,d,Year)", 3, "eafs", "list(a = 28, b = -0.02, d = 0.-2)", "list(a = 28, b = -0.02, d = 0.-2)", "coef(m2)", TRUE, fitAR1 = FALSE, num_data_points = num_data_points, ylabel, "Hassell", nofit = TRUE)
