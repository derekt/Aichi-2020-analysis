...
options(warn = -1)
  ...
  output_name = "T1_heard_of_biodiv"  
  #--------------------------------------------------------------------------------------
  
  
  # Read in and attach data
  eafs<-read.csv("Biodiversity_barometer_%heardofbiodiversity.csv")
  ...
  y_limit = 100
  ylabel = "Percent"
  maintitle = "Biodiversity Barometer: percentage heard of biodiversity (excl. Brazil)"
...
m[[2]] <- FitAutocorrelatedModel("ratk423", "(a,b,Year)", 2, "eafs", "list(a = 0.5, b = 1.1)", "coef(m1)", "coef(m1)", TRUE, ylabel, "2 parameter negative exponential", fitAR1 = FALSE, num_data_points = num_data_points)
...
m[[5]] <- FitAutocorrelatedModel("mmfun", "(a,b,Year)", 2, "eafs", "list(a = 1.1, b = 1)", "coef(m1)", "list(a = 1.3, b = 1.3)", TRUE, ylabel, "Michaelis-Menten", fitAR1 = FALSE, num_data_points = num_data_points)
...
m[[10]] <- FitAutocorrelatedModel("monofun", "(a,b,Year)", 2, "eafs", "list(a = 70, b = 0.005)", "coef(m1)", "coef(m2)", TRUE, ylabel, "Monomolecular", fitAR1 = FALSE, num_data_points = num_data_points)
...
m[[13]] <- FitAutocorrelatedModel("chaprichfun", "(a,b,d,Year)", 3, "eafs", "list(a = 40, b = 0.2,d = 0.2)", "list(a = 1.1, b = 0.1,d = 5)", "coef(m2)", TRUE, ylabel, "Chapman-Richards", nofit = TRUE, num_data_points = num_data_points)
...
#--------------------------------------------------------------------------------------
# MODEL 16: ASYMPTOTIC
m[[16]] <- FitAutocorrelatedModel("asymptoticfun", "(a,b,d,Year)", 3, "eafs", "list(a = 0.55, b = 0.08, d = 1.1)", "coef(m1)", "coef(m2)", TRUE, ylabel, "Asymptotic", nofit = TRUE, num_data_points = num_data_points)
...
#--------------------------------------------------------------------------------------
# MODEL 18: HASSELL
m[[18]] <- FitAutocorrelatedModel("hassellfun", "(a,b,d,Year)", 3, "eafs", "list(a = 2, b = 2, d = 0.98)", "coef(m1)", "coef(m2)", TRUE, ylabel, "Hassell", nofit = TRUE, num_data_points = num_data_points)
