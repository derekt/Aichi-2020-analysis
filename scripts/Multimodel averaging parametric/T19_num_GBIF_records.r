...
setwd("../../data/Target 19")
  ...
  output_name = "T19_GBIF_records"

# Read in and attach data
eafs<-read.csv("gbif_num_records.csv")
...
ylabel = "Number of records (millions)"
maintitle = "Records in GBIF"
...
#---------------------------------------------------------------------------------------
# MODEL 15: POWER-LAW
m[[15]] <- FitAutocorrelatedModel("powerfun", "(a,b,Year)", 2, "eafs", "list(a = 200, b = 0.8)", "list(a = 200, b = 0.8)", "list(a = 200, b = 0.8)", TRUE, num_data_points = num_data_points, ylabel, "Power", 0.01, 0.1, 0.1)
