...
setwd("../../data/Target 9")
  ...
  output_name = "T9_Introduction_Events"  


# Read in and attach data
eafs<-read.csv("BIP indicator IAS 21 countries2.csv")
eafs = eafs[44:dim(eafs)[1],1:2]
...
ylabel = "Cumulative introductions"
maintitle = "Introduction events (21 countries)"
...
m[[1]] <- FitAutocorrelatedModel("poly1fun", "(a,b,Year)", 2, "eafs", "list(a =-22, b = 50)", "coef(m1)", "coef(m1)", TRUE, num_data_points = num_data_points, ylabel, "First order polynomial")
  ...
  m[[3]] <- FitAutocorrelatedModel("ratk4333", "(a,b,c,Year)", 4, "eafs", "list(a = 100, b = -1, c = 0.5)", "coef(m1)", "coef(m2)", FALSE, ylabel, "3 parameter negative exponential")
