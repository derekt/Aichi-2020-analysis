...
eafs<-read.csv("PA_coverage_AZEs.csv")
colnames(eafs) = c("Year", "data") 


eafs[,2] = eafs[,2]

  output_name = "T11_PA_coverage_AZEs" 
...
maintitle = "Protected area coverage of Alliance for Zero Extinction sites"
...
m[[10]] <- FitAutocorrelatedModel("monofun", "(a,b,Year)", 2, "eafs", "list(a = 10, b = -0.01)", "coef(m1)", "coef(m2)", TRUE, num_data_points = num_data_points, ylabel, "Monomolecular")
...
#--------------------------------------------------------------------------------------
# MODEL 16: ASYMPTOTIC
m[[16]] <- FitAutocorrelatedModel("asymptoticfun", "(a,b,d,Year)", 3, "eafs", "list(a = 0.4, b = -0.1, d = 1.01)", "coef(m1)", "coef(m2)", TRUE, num_data_points = num_data_points, ylabel, "Asymptotic", 0.01)
