...
setwd("../../data/Target 19")
  ...
  output_name = "T19_WOS_biodiv_papers"

# Read in and attach data
eafs<-read.csv("wos_num_papers_biodiversity_title_limited.csv")
...
m[[1]] <- FitAutocorrelatedModel("poly1fun", "(a,b,Year)", 2, "eafs", "list(a =2, b = 50)", "coef(m1)", "coef(m1)", TRUE, num_data_points = num_data_points, ylabel, "First order polynomial")
...
m[[5]] <- FitAutocorrelatedModel("mmfun", "(a,b,Year)", 2, "eafs", "list(a = 10, b = 1)", "coef(m1)", "list(a = 1.3, b = 1.3)", TRUE, num_data_points = num_data_points, ylabel, "Michaelis-Menten")
...
#-------------------------------------------------------------------------------------
## MODEL 9: EXPONENTIAL  
m[[9]] <- FitAutocorrelatedModel("expfun", "(a,b,Year)", 2, "eafs", "list(a = 0.4, b = 0.3)", "coef(m1)", "coef(m1)", TRUE, num_data_points = num_data_points, ylabel, "Exponential")
