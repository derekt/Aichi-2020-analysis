...
setwd("../../data/Target 8")
  ...
  output_name = "T8_RLI_pollution_birds"


# Read in and attach data
eafs<-read.csv("RLI_birds_impacted_by_pollution_limited.csv")
...
ylabel = "Red List Index of species survival"
 maintitle = "Red List Index for birds showing trends driven by pollution"
...
writepdfsandresults(output_name, 0.92)